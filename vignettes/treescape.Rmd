...
knitr::opts_chunk$set(fig.width=10, fig.height=10, dpi=200, out.width="800", fig.path="figs/")
options(digits = 4)
```
...
```{r distances, fig.width=6, fig.height=6}
## table.image
...
```{r plotGroves, fig.width=5, fig.height=5}
...
```{r woodmice, fig.width=8, fig.height=8, cache=TRUE}
data(woodmiceTrees)
